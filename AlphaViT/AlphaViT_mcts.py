...
import random
import math
from nn_alphavit import NNetWrapper as nnet
        ...
        for _ in range(self.params.num_mcts_sims[self.game_name]):
            ...
            if node.terminal:
                ...
                if self.game_name != "Connect4" and self.game_name != "Connect4_65" and self.game_name != "Connect4_54":
                    ...
                    psa_vector /= np.sum(np.array([psa_vector[i * self.ini_g.ynum] for i in valid_moves])) + 1e-7
    ...
    def Get_prob(self):
        ...
        for i in self.root.children:
            if self.game_name != "Connect4" and self.game_name != "Connect4_65" and self.game_name != "Connect4_54":
                ...
                prob[i.move * self.ini_g.ynum] += i.nsa
        prob /= np.sum(prob)
        return(prob)
